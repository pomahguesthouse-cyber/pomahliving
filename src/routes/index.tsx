  ...
  return (
    <div className="h-screen overflow-hidden bg-[#d7d0c7] p-3 sm:p-5 lg:p-7 selection:bg-indigo-500/30">
      <div className="flex h-full flex-col overflow-hidden">
        ...
        <main className="hide-scrollbar relative min-h-0 flex-1 overflow-y-auto overflow-x-hidden overscroll-contain rounded-none border-x border-b border-white/70 bg-[#02050a] shadow-[0_35px_100px_rgba(15,23,42,0.35)]">
