...
function Landing() {
  return (
    <div className="min-h-screen bg-[#d7d0c7] p-3 sm:p-5 lg:p-7 selection:bg-indigo-500/30">
      <header className="sticky top-3 z-50 overflow-hidden rounded-[28px] border border-white/70 bg-[#02050a]/95 shadow-[0_30px_90px_rgba(2,5,10,0.42)] backdrop-blur-2xl sm:top-5 sm:rounded-[38px] lg:top-7 lg:rounded-[56px]">
      ...
      <main className="relative -mt-[1px] min-h-[calc(100vh-88px)] overflow-hidden rounded-b-[28px] border-x border-b border-white/70 bg-[#02050a] shadow-[0_35px_100px_rgba(15,23,42,0.35)] sm:rounded-b-[38px] lg:rounded-b-[56px]">
