  ...
  return (
    <div className="h-screen overflow-hidden bg-[#d7d0c7] p-3 sm:p-5 lg:p-7 selection:bg-indigo-500/30">
      <div className="flex h-full flex-col overflow-hidden">
        <header className="relative z-[999] shrink-0 isolation-isolate overflow-hidden rounded-t-[28px] rounded-b-none border-x border-t border-white/70 bg-[#02050a] shadow-[0_30px_90px_rgba(2,5,10,0.55)] sm:rounded-t-[38px] lg:rounded-t-[56px]">
          ...
          <div className="relative mx-auto flex max-w-7xl items-center justify-between px-5 py-4 sm:px-8 lg:px-10 lg:py-5">
            <Link to="/" className="flex items-center gap-3 group"><div className="relative"><div className="relative z-10 flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 text-sm font-bold text-white shadow-lg shadow-indigo-500/35 lg:h-12 lg:w-12">P</div><div className="absolute -inset-2 rounded-full bg-purple-500/25 blur-xl transition-opacity group-hover:opacity-80" /></div><span className="text-lg font-semibold tracking-tight text-white lg:text-xl">pomah<span className="text-indigo-400">/living</span></span></Link>
        ...
        <main className="hide-scrollbar relative min-h-0 flex-1 overflow-y-auto overflow-x-hidden overscroll-contain rounded-none border-x border-white/70 bg-[#02050a] shadow-[0_35px_100px_rgba(15,23,42,0.35)]">
        ...
        <footer className="relative z-[999] shrink-0 isolation-isolate overflow-hidden rounded-t-none rounded-b-[28px] border-x border-b border-white/70 bg-[#02050a] shadow-[0_-30px_90px_rgba(2,5,10,0.42)] sm:rounded-b-[38px] lg:rounded-b-[56px]">
          <div className="pointer-events-none absolute inset-0 -z-10 bg-[#02050a]" />
