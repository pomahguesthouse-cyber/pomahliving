  ...
  return (
    <div className="h-screen overflow-hidden bg-[#d7d0c7] p-3 sm:p-5 lg:p-7 selection:bg-indigo-500/30">
      <div className="flex h-full flex-col overflow-hidden rounded-[28px] sm:rounded-[38px] lg:rounded-[56px] border border-white/70 bg-[#02050a] shadow-[0_35px_100px_rgba(15,23,42,0.35)]">
        ...
        <main className="hide-scrollbar relative min-h-0 flex-1 overflow-y-auto overflow-x-hidden overscroll-contain bg-transparent">
        ...
        <footer className="relative z-[999] shrink-0 isolation-isolate overflow-hidden rounded-t-none rounded-b-[28px] bg-transparent sm:rounded-b-[38px] lg:rounded-b-[56px]">
          <div className="pointer-events-none absolute inset-0 -z-10 bg-transparent" />
          <div className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_50%_100%,rgba(99,102,241,0.10),transparent_58%)]" />
